    ...
    def __init__(self, input_dim, hidden_dim=1000):
        ...
        with tf.variable_scope('neural_network'):
            ...
            with tf.variable_scope('layer_1'):
                W_1 = tf.get_variable('W_1', shape=[input_dim, hidden_dim], initializer=tf.contrib.layers.xavier_initializer())
            ...
            with tf.variable_scope('layer_2'):
                W_2 = tf.get_variable('W_2', shape=[hidden_dim, 1], initializer=tf.contrib.layers.xavier_initializer())
